...
<body>
    ...
    <div class="landscape">
        ...
        <div class="display-text">
            <p class="text-center">TOP PICKS FOR BIKE ROUTES</p>
        </div>
    </div>
	...
	<div class="wrapper">
		<div class="container">
			...
			<?php foreach (($bikes?:[]) as $bike): ?>
				<div class="row bike-location">
					<div class="col-md-4">
						<img class="img-responsive img-thumbnail" id="" src="images/<?= $bike->getPicture() ?>" alt="">
					</div>
					<div class="col-md-8">
						<h3><?= $bike->getMainTitle() ?><br><small><?= $bike->getSubTitle() ?></small></h3>
						<span class="hashtags"><i class="fa fa-hashtag" aria-hidden="true"></i> Bike</span>
