		...
		<div class="row bike-location">
			<div class="col-md-4">
				<a href="#" target="_blank">
					<img class="img-responsive img-thumbnail" id="" src="http://images.singletracks.com/blog/wp-content/uploads/2013/12/MRP4238-small-0.jpg" alt="">
				</a>
			</div>
			<div class="col-md-8">
				...
				<span class="hashtags"><i class="fa fa-hashtag" aria-hidden="true"></i> Biking</span>
