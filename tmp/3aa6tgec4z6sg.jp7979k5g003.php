...
<body>
  ...
  <div class="container">
    <div class="card card-container">
        ...
        <form action="./submit-user" method="post" enctype="multipart/form-data" id="user-form" class="form-signin form-vertical" autocomplete="on">
          ...
          <!-- SUBMIT BUTTON -->
          <hr>
          <input class="btn btn-lg btn-primary btn-block btn-signin" name="action" id="submit" type="submit" value="SIGN ME UP">
          </input>
