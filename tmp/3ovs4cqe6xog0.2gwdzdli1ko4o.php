		...
		<div class="row chill-location">
			<div class="col-md-4">
				<a href="#" target="_blank">
					<img class="img-responsive img-thumbnail" id="" src="http://www.city-data.com/forum/attachments/general-u-s/124043d1389870831-oregon-scenery-vs-washington-scenery-washington_state_crystalline_lakes_landscapes_mountains_1366x768_67705.jpg" alt="">
				</a>
			</div>
			<div class="col-md-8">
				...
				<span class="hashtags"><i class="fa fa-hashtag" aria-hidden="true"></i> Chilling</span>
